...
The calculation of the most significant deviations in the kinematic distributions is very computation intensive. This work features an additional selection step which significantly improves computation performance while keeping the same physical results: before the calculation of a complex integral, a simpler term is evaluated to estimate the significance of a certain region. The performance gain with this procedure is about \unit{XYZ}{\%} and will enable the MUSiC-group to perform more accurate analyses in the future. \todo{insert performance numbers here}
